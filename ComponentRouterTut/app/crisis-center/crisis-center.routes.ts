...
export const CrisisCenterRoutes: RouterConfig = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'admin',//admin should only be accesible to autheticated users, added a link in AppComponent Shell so that users can click on this featrue
        ...
        canActivate: [AuthGuard] /// => Look at this
      },
      /*
...
If the user approves, the app can save. => Crisis Detail Component
      */
      {
        path: ':id', //Just a parameter
        component: CrisisDetailComponent,
        canDeactivate: [CanDeactivateGuard] //Found in interfaces
      },
      {
        path: '',
