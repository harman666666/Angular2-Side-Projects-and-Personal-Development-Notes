...
var DemoFormSkuBuilder = (function () {
    ...
    DemoFormSkuBuilder = __decorate([
        core_1.Component({
            ...
            directives: [forms_2.FORM_DIRECTIVES, forms_2.REACTIVE_FORM_DIRECTIVES],
            template: "  \n  <div class=\"ui raised segment\">  \n    <h2 class=\"ui header\">Demo Form: Sku with Builder</h2>  \n    <form [formGroup]=\"myForm\"  \n          (ngSubmit)=\"onSubmit(myForm.value)\"  \n          class=\"ui form\">\n \n      <div class=\"field\">  \n        <label for=\"skuInput\">SKU</label>  \n        <input type=\"text\"  \n               id=\"skuInput\"  \n               placeholder=\"SKU\"  \n               [formControl]=\"myForm.controls['sku']\">  \n      </div>\n \n    <button type=\"submit\" class=\"ui button\">Submit</button>  \n    </form>  \n  </div>  \n  "
        }), 
        __metadata('design:paramtypes', [(typeof (_a = typeof forms_2.FormBuilder !== 'undefined' && forms_2.FormBuilder) === 'function' && _a) || Object])
    ], DemoFormSkuBuilder);
...
First Way:
*/
var DemoFormWithValidationsExplicitTutorial = (function () {
    function DemoFormWithValidationsExplicitTutorial(fb) {
        this.myForm = fb.group({
            'sku': ['', forms_2.Validators.required]
        });
        this.sku = this.myForm.controls['sku'];
    }
    DemoFormWithValidationsExplicitTutorial.prototype.onSubmit = function (value) {
        console.log('you submitted value: ', value);
    };
    return DemoFormWithValidationsExplicitTutorial;
}());
exports.DemoFormWithValidationsExplicitTutorial = DemoFormWithValidationsExplicitTutorial;
/*
...
platform_browser_dynamic_1.bootstrap(DemoFormWithValidationsExplicit, [
...
var DemoFormNgModel = (function () {
    function DemoFormNgModel(fb) {
        this.myForm = fb.group({
            'productName': ['', forms_2.Validators.required]
        });
    }
